...
<t:main title="${title}">
	...
	<stripes:form beanclass="com.criticalsoftware.mobics.presentation.action.trip.DamageReportActionBean" method="POST">
		...
		<article class="pin">
			<section>
				...
				<div>
					<stripes:submit id="continueToTrip" name="data"><fmt:message key="pin.button"/></stripes:submit>
				</div>
			</section>
		</article>
	</stripes:form>			
